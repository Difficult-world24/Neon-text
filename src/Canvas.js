...
function Canvas(props) {
  ...
  return (
    ...
    >
      ...
      />
      <Typography textAlign={'center'} sx={{ marginBottom: '5px' }}>
        Select corners to resize the canvas dynamically
      </Typography>
      <Grid
        container
        spacing={2}
      ...
      >
        <Grid item xs={5}>
          <TextField
            ...
            onChange={(e) => {
              setFontSize(
                document.querySelector('.ghost').clientHeight / divisionNumber
              )
              setTextSize((o) => ({
                ...o,
                width: convertUnitToPoint(e.target.value, selectedUnit),
        ...
        >
          ...
          {charData.map((item) => {
            return (
              ...
              >
                <img
                  style={{ margin: '4px', width: '72px', height: '72px' }}
                  src={item.img}
                  alt='Letter'
                />
                <div
                ...
                >
                  {[
                    {
                      label: 'Width',
                      value: item.stats.width,
                    },
                    {
                      label: 'Height',
                      value: item.stats.height,
                    },
                    {
                      label: 'Stroke',
                      value: item.stats.stroke,
                    },
                  ].map(({ label, value }) => (
                    <div
                      style={{
